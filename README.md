A [One-click installer for Windows](https://github.com/IgorAherne/hunyan-2-1-stable-projectorz/releases/tag/latest): (Python 3.11, Cuda 12.8) optimized for gpus, to run efficiently with 8GB instead of 16GB.
