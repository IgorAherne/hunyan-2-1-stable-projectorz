A [One-click installer for Windows](https://github.com/IgorAherne/hunyan-2-1-stable-projectorz/releases/tag/latest): (Python 3.11, Cuda 12.8) <br>Optimized to run efficiently with 8GB gpus instead of 16GB.
